...
define config.name = _("Quando Jack se Impressiona")
...
define build.name = "QuandoJackSeImpressiona"
...
define config.save_directory = "QuandoJackSeImpressiona-1747406360"
